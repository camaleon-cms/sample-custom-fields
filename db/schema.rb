...
ActiveRecord::Schema.define(version: 20170614103252) do
  ...
  create_table "cama_media_files", force: :cascade do |t|
    t.integer "site_id"
    t.string "group_key", default: "cama_media_cache"
    t.string "key"
    t.string "name"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["group_key"], name: "index_cama_media_files_on_group_key"
    t.index ["key"], name: "index_cama_media_files_on_key"
    t.index ["parent_id"], name: "index_cama_media_files_on_parent_id"
    t.index ["site_id"], name: "index_cama_media_files_on_site_id"
  end
